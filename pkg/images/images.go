...
// ROption is an option to modify image resolution behavior.
type ROption func(name.Reference) error
...
func (r *Resolver) GetReference(i string, opts ...ROption) (name.Reference, error) {
...
func (r *Resolver) MustGetReference(i string, opts ...ROption) name.Reference {
...
func WithRegistry(s string) ROption {
